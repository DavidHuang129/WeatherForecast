...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _nameLabel = [DHView createLabelWithFrame:CGRectMake(0, 10, SCREEN_WIDTH, 40) text:@"未知" font:FONT(20) textColor:COLOR_WHITECOLOR];
        _nameLabel.textAlignment = NSTextAlignmentCenter;
        [self addSubview:_nameLabel];
        
        _tempLabel = [DHView createLabelWithFrame:CGRectMake(0, _nameLabel.maxY + 10, SCREEN_WIDTH, 80) text:@"N/A" font:FONT(80) textColor:COLOR_WHITECOLOR];
        ...
        _weatherLabel = [DHView createLabelWithFrame:CGRectMake(_weatherIcon.maxX + 10 , _weatherIcon.center.y, SCREEN_WIDTH / 2 - 20, 20) text:@"没有网络数据" font:FONT(15) textColor:COLOR_WHITECOLOR];
