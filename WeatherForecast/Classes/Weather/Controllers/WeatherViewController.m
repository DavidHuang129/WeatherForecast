...
- (void)loadWeatherData
{
    ...
    [DHTool sendAFNetworkGet:url parameters:nil success:^(id responseObject) {
...
{
    [DHTool sendAFNetworkGet:kWeather parameters:@{@"cityIds" : cityModel.code} success:^(id responseObject) {
