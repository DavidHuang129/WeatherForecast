...
- (void)createCollectionView
{
    ...
    // 指数描述
    _contentLabel = [DHView createLabelWithFrame:CGRectMake(10, _collectionView.maxY, SCREEN_WIDTH - 20, 44) text:@"指数描述——点击相应指数显示信息" font:FONT(15) textColor:[UIColor blackColor]];
